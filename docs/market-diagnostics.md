...
O service worker procura uma aba IQ Option válida em vez de assumir que a página do side panel é a aba de mercado. Ao instalar ou recarregar a extensão, ele também tenta instalar os scripts de leitura nas traderooms que já estavam abertas. Caso o Chrome impeça essa recuperação, o dashboard solicita explicitamente que a aba seja recarregada.

    ...
    >
      <div className="section-heading">
        ...
        <label className="diagnostics-switch">
          <input
            ...
            disabled={!diagnostics.available || diagnostics.reloadRequired}
      ...
      {!diagnostics.available && (
        <p className="diagnostic-note">
          Abra uma aba da IQ Option para habilitar o diagnóstico.
        </p>
      )}
      {diagnostics.reloadRequired && (
        <p className="bridge-guidance">
          Recarregue a aba da IQ Option antes de ativar o diagnóstico.
        </p>
      )}
